...
class Edge(object):
    ...
    # Prende in input nodo di partenza, di arrivo, costo (default = 1 se non indicato)
    def __init__(self, fromNode, toNode, cost=1):
    ...
    # Dato un nodo di input, darà True se questo è coinvolto nell'arco altrimenti False
